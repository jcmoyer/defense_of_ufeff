...
const function_signatures = struct {
    ...
    const glPointSize = *const fn (_size: GLfloat) void;
    const glPolygonMode = *const fn (_face: GLenum, _mode: GLenum) void;
    ...
    const glTexImage1D = *const fn (_target: GLenum, _level: GLint, _internalformat: GLint, _width: GLsizei, _border: GLint, _format: GLenum, _type: GLenum, _pixels: ?*const anyopaque) void;
    ...
    const glDrawBuffer = *const fn (_buf: GLenum) void;
    ...
    const glClearDepth = *const fn (_depth: GLdouble) void;
    ...
    const glLogicOp = *const fn (_opcode: GLenum) void;
    ...
    const glPixelStoref = *const fn (_pname: GLenum, _param: GLfloat) void;
    ...
    const glGetDoublev = *const fn (_pname: GLenum, _data: [*c]GLdouble) void;
    ...
    const glGetTexImage = *const fn (_target: GLenum, _level: GLint, _format: GLenum, _type: GLenum, _pixels: ?*anyopaque) void;
    ...
    const glGetTexLevelParameterfv = *const fn (_target: GLenum, _level: GLint, _pname: GLenum, _params: [*c]GLfloat) void;
    const glGetTexLevelParameteriv = *const fn (_target: GLenum, _level: GLint, _pname: GLenum, _params: [*c]GLint) void;
    const glIsEnabled = *const fn (_cap: GLenum) GLboolean;
    const glDepthRange = *const fn (_n: GLdouble, _f: GLdouble) void;
    ...
    const glCopyTexImage1D = *const fn (_target: GLenum, _level: GLint, _internalformat: GLenum, _x: GLint, _y: GLint, _width: GLsizei, _border: GLint) void;
    ...
    const glCopyTexSubImage1D = *const fn (_target: GLenum, _level: GLint, _xoffset: GLint, _x: GLint, _y: GLint, _width: GLsizei) void;
    ...
    const glTexSubImage1D = *const fn (_target: GLenum, _level: GLint, _xoffset: GLint, _width: GLsizei, _format: GLenum, _type: GLenum, _pixels: ?*const anyopaque) void;
    ...
    const glCompressedTexImage1D = *const fn (_target: GLenum, _level: GLint, _internalformat: GLenum, _width: GLsizei, _border: GLint, _imageSize: GLsizei, _data: ?*const anyopaque) void;
    ...
    const glCompressedTexSubImage1D = *const fn (_target: GLenum, _level: GLint, _xoffset: GLint, _width: GLsizei, _format: GLenum, _imageSize: GLsizei, _data: ?*const anyopaque) void;
    const glGetCompressedTexImage = *const fn (_target: GLenum, _level: GLint, _img: ?*anyopaque) void;
    const glVertexAttribP4uiv = *const fn (_index: GLuint, _type: GLenum, _normalized: GLboolean, _value: [*c]const GLuint) void;
    const glVertexAttribP4ui = *const fn (_index: GLuint, _type: GLenum, _normalized: GLboolean, _value: GLuint) void;
    const glVertexAttribP3uiv = *const fn (_index: GLuint, _type: GLenum, _normalized: GLboolean, _value: [*c]const GLuint) void;
    const glVertexAttribP3ui = *const fn (_index: GLuint, _type: GLenum, _normalized: GLboolean, _value: GLuint) void;
    const glVertexAttribP2uiv = *const fn (_index: GLuint, _type: GLenum, _normalized: GLboolean, _value: [*c]const GLuint) void;
    const glVertexAttribP2ui = *const fn (_index: GLuint, _type: GLenum, _normalized: GLboolean, _value: GLuint) void;
    const glVertexAttribP1uiv = *const fn (_index: GLuint, _type: GLenum, _normalized: GLboolean, _value: [*c]const GLuint) void;
    const glVertexAttribP1ui = *const fn (_index: GLuint, _type: GLenum, _normalized: GLboolean, _value: GLuint) void;
    const glVertexAttribDivisor = *const fn (_index: GLuint, _divisor: GLuint) void;
    const glGetQueryObjectui64v = *const fn (_id: GLuint, _pname: GLenum, _params: [*c]GLuint64) void;
    const glGetQueryObjecti64v = *const fn (_id: GLuint, _pname: GLenum, _params: [*c]GLint64) void;
    const glQueryCounter = *const fn (_id: GLuint, _target: GLenum) void;
    const glGetSamplerParameterIuiv = *const fn (_sampler: GLuint, _pname: GLenum, _params: [*c]GLuint) void;
    const glGetSamplerParameterfv = *const fn (_sampler: GLuint, _pname: GLenum, _params: [*c]GLfloat) void;
    const glGetSamplerParameterIiv = *const fn (_sampler: GLuint, _pname: GLenum, _params: [*c]GLint) void;
    const glGetSamplerParameteriv = *const fn (_sampler: GLuint, _pname: GLenum, _params: [*c]GLint) void;
    const glSamplerParameterIuiv = *const fn (_sampler: GLuint, _pname: GLenum, _param: [*c]const GLuint) void;
    const glSamplerParameterIiv = *const fn (_sampler: GLuint, _pname: GLenum, _param: [*c]const GLint) void;
    ...
    const glGetFragDataIndex = *const fn (_program: GLuint, _name: [*c]const GLchar) GLint;
    const glBindFragDataLocationIndexed = *const fn (_program: GLuint, _colorNumber: GLuint, _index: GLuint, _name: [*c]const GLchar) void;
    const glSampleMaski = *const fn (_maskNumber: GLuint, _mask: GLbitfield) void;
    const glGetMultisamplefv = *const fn (_pname: GLenum, _index: GLuint, _val: [*c]GLfloat) void;
    const glTexImage3DMultisample = *const fn (_target: GLenum, _samples: GLsizei, _internalformat: GLenum, _width: GLsizei, _height: GLsizei, _depth: GLsizei, _fixedsamplelocations: GLboolean) void;
    const glTexImage2DMultisample = *const fn (_target: GLenum, _samples: GLsizei, _internalformat: GLenum, _width: GLsizei, _height: GLsizei, _fixedsamplelocations: GLboolean) void;
    const glFramebufferTexture = *const fn (_target: GLenum, _attachment: GLenum, _texture: GLuint, _level: GLint) void;
    ...
    const glMultiDrawArrays = *const fn (_mode: GLenum, _first: [*c]const GLint, _count: [*c]const GLsizei, _drawcount: GLsizei) void;
    const glMultiDrawElements = *const fn (_mode: GLenum, _count: [*c]const GLsizei, _type: GLenum, _indices: [*c]const ?*const anyopaque, _drawcount: GLsizei) void;
    const glPointParameterf = *const fn (_pname: GLenum, _param: GLfloat) void;
    const glPointParameterfv = *const fn (_pname: GLenum, _params: [*c]const GLfloat) void;
    const glPointParameteri = *const fn (_pname: GLenum, _param: GLint) void;
    const glPointParameteriv = *const fn (_pname: GLenum, _params: [*c]const GLint) void;
    ...
    const glProvokingVertex = *const fn (_mode: GLenum) void;
    const glMultiDrawElementsBaseVertex = *const fn (_mode: GLenum, _count: [*c]const GLsizei, _type: GLenum, _indices: [*c]const ?*const anyopaque, _drawcount: GLsizei, _basevertex: [*c]const GLint) void;
    const glDrawElementsInstancedBaseVertex = *const fn (_mode: GLenum, _count: GLsizei, _type: GLenum, _indices: ?*const anyopaque, _instancecount: GLsizei, _basevertex: GLint) void;
    const glDrawRangeElementsBaseVertex = *const fn (_mode: GLenum, _start: GLuint, _end: GLuint, _count: GLsizei, _type: GLenum, _indices: ?*const anyopaque, _basevertex: GLint) void;
    const glDrawElementsBaseVertex = *const fn (_mode: GLenum, _count: GLsizei, _type: GLenum, _indices: ?*const anyopaque, _basevertex: GLint) void;
    ...
    const glGetQueryObjectiv = *const fn (_id: GLuint, _pname: GLenum, _params: [*c]GLint) void;
    ...
    const glGetBufferSubData = *const fn (_target: GLenum, _offset: GLintptr, _size: GLsizeiptr, _data: ?*anyopaque) void;
    const glMapBuffer = *const fn (_target: GLenum, _access: GLenum) ?*anyopaque;
    ...
    const glGetVertexAttribdv = *const fn (_index: GLuint, _pname: GLenum, _params: [*c]GLdouble) void;
    ...
    const glVertexAttrib1d = *const fn (_index: GLuint, _x: GLdouble) void;
    const glVertexAttrib1dv = *const fn (_index: GLuint, _v: [*c]const GLdouble) void;
    ...
    const glVertexAttrib1s = *const fn (_index: GLuint, _x: GLshort) void;
    const glVertexAttrib1sv = *const fn (_index: GLuint, _v: [*c]const GLshort) void;
    const glVertexAttrib2d = *const fn (_index: GLuint, _x: GLdouble, _y: GLdouble) void;
    const glVertexAttrib2dv = *const fn (_index: GLuint, _v: [*c]const GLdouble) void;
    ...
    const glVertexAttrib2s = *const fn (_index: GLuint, _x: GLshort, _y: GLshort) void;
    const glVertexAttrib2sv = *const fn (_index: GLuint, _v: [*c]const GLshort) void;
    const glVertexAttrib3d = *const fn (_index: GLuint, _x: GLdouble, _y: GLdouble, _z: GLdouble) void;
    const glVertexAttrib3dv = *const fn (_index: GLuint, _v: [*c]const GLdouble) void;
    ...
    const glVertexAttrib3s = *const fn (_index: GLuint, _x: GLshort, _y: GLshort, _z: GLshort) void;
    const glVertexAttrib3sv = *const fn (_index: GLuint, _v: [*c]const GLshort) void;
    const glVertexAttrib4Nbv = *const fn (_index: GLuint, _v: [*c]const GLbyte) void;
    const glVertexAttrib4Niv = *const fn (_index: GLuint, _v: [*c]const GLint) void;
    const glVertexAttrib4Nsv = *const fn (_index: GLuint, _v: [*c]const GLshort) void;
    const glVertexAttrib4Nub = *const fn (_index: GLuint, _x: GLubyte, _y: GLubyte, _z: GLubyte, _w: GLubyte) void;
    const glVertexAttrib4Nubv = *const fn (_index: GLuint, _v: ?[*:0]const GLubyte) void;
    const glVertexAttrib4Nuiv = *const fn (_index: GLuint, _v: [*c]const GLuint) void;
    const glVertexAttrib4Nusv = *const fn (_index: GLuint, _v: [*c]const GLushort) void;
    const glVertexAttrib4bv = *const fn (_index: GLuint, _v: [*c]const GLbyte) void;
    const glVertexAttrib4d = *const fn (_index: GLuint, _x: GLdouble, _y: GLdouble, _z: GLdouble, _w: GLdouble) void;
    const glVertexAttrib4dv = *const fn (_index: GLuint, _v: [*c]const GLdouble) void;
    ...
    const glVertexAttrib4iv = *const fn (_index: GLuint, _v: [*c]const GLint) void;
    const glVertexAttrib4s = *const fn (_index: GLuint, _x: GLshort, _y: GLshort, _z: GLshort, _w: GLshort) void;
    const glVertexAttrib4sv = *const fn (_index: GLuint, _v: [*c]const GLshort) void;
    const glVertexAttrib4ubv = *const fn (_index: GLuint, _v: ?[*:0]const GLubyte) void;
    const glVertexAttrib4uiv = *const fn (_index: GLuint, _v: [*c]const GLuint) void;
    const glVertexAttrib4usv = *const fn (_index: GLuint, _v: [*c]const GLushort) void;
    ...
    const glColorMaski = *const fn (_index: GLuint, _r: GLboolean, _g: GLboolean, _b: GLboolean, _a: GLboolean) void;
    const glGetBooleani_v = *const fn (_target: GLenum, _index: GLuint, _data: [*c]GLboolean) void;
    const glGetIntegeri_v = *const fn (_target: GLenum, _index: GLuint, _data: [*c]GLint) void;
    const glEnablei = *const fn (_target: GLenum, _index: GLuint) void;
    const glDisablei = *const fn (_target: GLenum, _index: GLuint) void;
    const glIsEnabledi = *const fn (_target: GLenum, _index: GLuint) GLboolean;
    ...
    const glClampColor = *const fn (_target: GLenum, _clamp: GLenum) void;
    const glBeginConditionalRender = *const fn (_id: GLuint, _mode: GLenum) void;
    const glEndConditionalRender = *const fn () void;
    ...
    const glVertexAttribI1i = *const fn (_index: GLuint, _x: GLint) void;
    const glVertexAttribI2i = *const fn (_index: GLuint, _x: GLint, _y: GLint) void;
    const glVertexAttribI3i = *const fn (_index: GLuint, _x: GLint, _y: GLint, _z: GLint) void;
    const glVertexAttribI4i = *const fn (_index: GLuint, _x: GLint, _y: GLint, _z: GLint, _w: GLint) void;
    const glVertexAttribI1ui = *const fn (_index: GLuint, _x: GLuint) void;
    const glVertexAttribI2ui = *const fn (_index: GLuint, _x: GLuint, _y: GLuint) void;
    const glVertexAttribI3ui = *const fn (_index: GLuint, _x: GLuint, _y: GLuint, _z: GLuint) void;
    const glVertexAttribI4ui = *const fn (_index: GLuint, _x: GLuint, _y: GLuint, _z: GLuint, _w: GLuint) void;
    const glVertexAttribI1iv = *const fn (_index: GLuint, _v: [*c]const GLint) void;
    const glVertexAttribI2iv = *const fn (_index: GLuint, _v: [*c]const GLint) void;
    const glVertexAttribI3iv = *const fn (_index: GLuint, _v: [*c]const GLint) void;
    const glVertexAttribI4iv = *const fn (_index: GLuint, _v: [*c]const GLint) void;
    const glVertexAttribI1uiv = *const fn (_index: GLuint, _v: [*c]const GLuint) void;
    const glVertexAttribI2uiv = *const fn (_index: GLuint, _v: [*c]const GLuint) void;
    const glVertexAttribI3uiv = *const fn (_index: GLuint, _v: [*c]const GLuint) void;
    const glVertexAttribI4uiv = *const fn (_index: GLuint, _v: [*c]const GLuint) void;
    const glVertexAttribI4bv = *const fn (_index: GLuint, _v: [*c]const GLbyte) void;
    const glVertexAttribI4sv = *const fn (_index: GLuint, _v: [*c]const GLshort) void;
    const glVertexAttribI4ubv = *const fn (_index: GLuint, _v: ?[*:0]const GLubyte) void;
    const glVertexAttribI4usv = *const fn (_index: GLuint, _v: [*c]const GLushort) void;
    const glGetUniformuiv = *const fn (_program: GLuint, _location: GLint, _params: [*c]GLuint) void;
    const glBindFragDataLocation = *const fn (_program: GLuint, _color: GLuint, _name: [*c]const GLchar) void;
    ...
    const glTexParameterIiv = *const fn (_target: GLenum, _pname: GLenum, _params: [*c]const GLint) void;
    const glTexParameterIuiv = *const fn (_target: GLenum, _pname: GLenum, _params: [*c]const GLuint) void;
    const glGetTexParameterIiv = *const fn (_target: GLenum, _pname: GLenum, _params: [*c]GLint) void;
    const glGetTexParameterIuiv = *const fn (_target: GLenum, _pname: GLenum, _params: [*c]GLuint) void;
    ...
    const glFramebufferTexture1D = *const fn (_target: GLenum, _attachment: GLenum, _textarget: GLenum, _texture: GLuint, _level: GLint) void;
    ...
    const glFramebufferTexture3D = *const fn (_target: GLenum, _attachment: GLenum, _textarget: GLenum, _texture: GLuint, _level: GLint, _zoffset: GLint) void;
    ...
    const glTexBuffer = *const fn (_target: GLenum, _internalformat: GLenum, _buffer: GLuint) void;
    const glPrimitiveRestartIndex = *const fn (_index: GLuint) void;
    ...
    const glGetActiveUniformName = *const fn (_program: GLuint, _uniformIndex: GLuint, _bufSize: GLsizei, _length: [*c]GLsizei, _uniformName: [*c]GLchar) void;
